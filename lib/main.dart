...
import 'package:movies_project/features/history_list/Cubit/history_list_cubit.dart'; // import الجديد
...
import 'features/update_profile/manager/selected_avatar_cubit.dart';
      ...
      builder: (context, child) {
        return MultiBlocProvider(
          providers: [
            ...
            BlocProvider(create: (context) => getIt<WatchListCubit>()..loadWatchList()),
